...
router.route("/:id")
    .get(authenticateToken, authorizeRole(['Solicitante', 'N1', 'N2']), validateId, validateInputs, applicantController.getApplicantById);

// Route to get cost center by user ID
router.route("/get-cc/:user_id")
    .get(authenticateToken, authorizeRole(['Solicitante', 'N1', 'N2']), validateId, validateInputs, applicantController.getCostCenterByUserId);

router.route("/create-travel-request/:id")
    .post(authenticateToken, authorizeRole(['Solicitante', 'N1', 'N2']), validateId, validateTravelRequest, validateInputs, applicantController.createTravelRequest);

router.route("/edit-travel-request/:id")
    .put(authenticateToken, authorizeRole(['Solicitante', 'N1', 'N2']), validateId, validateTravelRequest, validateInputs, applicantController.editTravelRequest);

router.route("/cancel-travel-request/:request_id")
    .put(authenticateToken, authorizeRole(['Solicitante', 'N1', 'N2']), validateId, validateInputs, applicantController.cancelTravelRequest);

router.route("/create-expense-validation")
    .post(authenticateToken, authorizeRole(['Solicitante', 'N1', 'N2']), validateExpenseReceipts, validateInputs, applicantController.createExpenseValidationHandler);
...
router.route("/confirm-draft-travel-request/:user_id/:request_id")
    .put(authenticateToken, authorizeRole(['Solicitante', 'N1', 'N2']), validateId, validateInputs, applicantController.confirmDraftTravelRequest);

router.route("/send-expense-validation/:request_id")
    .put(authenticateToken, authorizeRole(['Solicitante', 'N1', 'N2']), validateId, validateInputs, applicantController.sendExpenseValidation);
