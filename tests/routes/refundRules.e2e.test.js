...
async function seedCatalogs() {
  // Roles + permissions seeded by prisma/seed.js — reuse in tests
  await import("../../prisma/seed.js").catch(() => null); // seed module has side effects only when run as script
  // Force a minimal subset:
